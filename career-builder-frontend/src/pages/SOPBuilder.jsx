...
${fullName}
  ...
  const QuestionBox = ({ title, subtitle, children }) => (
...
const downloadSOP = () => {
  ...
  <div className="text-center mb-10">
    <h1 className="text-4xl font-extrabold text-blue-700 tracking-tight">SOP Builder</h1>
    <p className="text-gray-600 text-lg mt-2">Answer simple questions → Get a refined academic Statement of Purpose</p>
  </div>
